...
def parse_args():
    ...
    parser.add_argument('--input', nargs='?', default='/Users/sanika/Downloads/Data_Science_Seminar/facebook_combined.txt',
                        help='Input graph path')

	#parser.add_argument('--input', nargs='?', default='facebook.edgelist',
	#                    help='Input graph path')
